...
README 的 Agent 图标均落盘为仓库内相对资源，避免 GitHub camo、外部 CDN 或组织头像别名导致破图。
...
`mascot-abigail.png` 是本仓库原有 `mascot-abigail.webp` 的 PNG 无损转存版本；README 使用 PNG 是为兼容 GitHub README 图片渲染，原 WebP 保留作源文件。
